...
const Navbar = () => {
    ...
    return (
        <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
            ...
            <div className={`flex max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium
            max-md:text-lg z-50 flex-col md:flex-row items-center
            ...
            <div className='flex items-center gap-8'>
                ...
                {/* if user is not logged in it will show button else profile of user */}
                {
                    !user ? (
