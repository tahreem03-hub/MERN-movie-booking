            ...
            <div className='group grid grid-cols-4 gap-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
                {dummyTrailers.map((trailer)=>(
                    ...
                    onClick={()=>setCurrentTrailer(trailer)}>
                        ...
                        {/* top-1/2 left-1/2 — moves icon's top-left corner to center of parent.
                    -translate-x-1/2 -translate-y-1/2 — pulls icon back by half its own size */}
