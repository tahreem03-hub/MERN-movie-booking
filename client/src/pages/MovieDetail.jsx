...
const MovieDetail = () => {
  const { user, getToken, axios, shows, fetchFavouriteMovies, favouriteMovies, image_base_url } = useAppContext()
    ...
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      ...
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <p>
            {TimeForamt(show.movie.runtime)} • {show.movie.genres.map((genre) => genre.name).join(", ")} • {show.movie.release_date.split("-")[0]}
          </p>
          ...
          <div className='flex items-center flex-wrap gap-4 mt-4'>
            ...
            active:scale-95'> <PlayCircleIcon className='w-5 h-5' /> Watch Trailer</button>
            ...
            onClick={handleFavourite}>
              <Heart className={`w- 5 h- 5 ${favouriteMovies.find(movie => movie._id === id)
      ...
      <div className='overflow-x-auto no-scrollbar mt-8 pb-8'>
